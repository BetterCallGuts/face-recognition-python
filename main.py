...
class FaceRecognition:
  ...
  def encode_faces(self):
    for img in os.listdir('faces'):
      face_img      = face_recognition.load_image_file(f"faces/{img}")
    ...
    while True:
      ...
      if self.process_current_frame:
        ...
        for face_encoding in self.face_encodings:
          matchs     = face_recognition.compare_faces(self.known_face_encodings, face_encoding)
          name       = "Unknown"
          confidence = "Unknown"
